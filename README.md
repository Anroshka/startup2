...
> **Стадия проекта:** подготовка MVP. В репозитории находятся описание продукта и готовая система фирменного стиля. Приложение и интеграции пока не реализованы; ниже описан планируемый продукт.
...
Продукт находится на этапе проектирования. Команду запуска приложения добавим вместе с первой реализацией.
