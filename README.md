...
> **Стадия проекта:** веб-MVP. В коде есть поиск через API hh.ru, AI-разбор и черновики через OpenRouter, онбординг, кабинет и трекер. Работа интеграций на конкретном развёртывании зависит от ключей и миграций; автоматической отправки откликов нет.
