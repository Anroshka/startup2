...
function GitHubMark() {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M12 .7a11.5 11.5 0 0 0-3.64 22.41c.58.1.79-.25.79-.56v-2.23c-3.22.7-3.9-1.37-3.9-1.37-.53-1.34-1.29-1.7-1.29-1.7-1.05-.72.08-.71.08-.71 1.16.08 1.77 1.19 1.77 1.19 1.04 1.77 2.72 1.26 3.38.96.1-.75.4-1.26.73-1.55-2.57-.29-5.27-1.28-5.27-5.68 0-1.26.45-2.28 1.19-3.09-.12-.29-.52-1.47.11-3.05 0 0 .97-.31 3.16 1.18A10.98 10.98 0 0 1 12 6.12c.98 0 1.96.13 2.87.39 2.2-1.49 3.16-1.18 3.16-1.18.63 1.58.23 2.76.11 3.05.74.81 1.19 1.83 1.19 3.09 0 4.41-2.71 5.38-5.29 5.67.42.36.79 1.06.79 2.14v3.27c0 .31.21.67.8.56A11.5 11.5 0 0 0 12 .7Z" />
    </svg>
  );
}
function safeNext() {
  ...
  return v?.startsWith("/") && !v.startsWith("//") ? v : "/onboarding";
}
...
export default function LoginPage() {
  ...
  async function emailAuth(mode: "signin" | "signup") {
    ...
    setMessage("Аккаунт создан. Подтвердите email по ссылке в письме.");
    setLoading("");
  }
  return (
    <div className="onboarding">
      <aside className="onboard-aside">
        ...
        <div>
          ...
          <p>Сохраняйте профиль, вакансии и отклики между устройствами.</p>
        </div>
        <span className="onboard-foot">JobPilot · ранний доступ</span>
      </aside>
      <main className="onboard-main">
        ...
        <div className="onboard-form">
          ...
          <p className="field-hint">
            Продолжая, вы создаёте аккаунт JobPilot. Платёжные данные не
            требуются.
          </p>
        </div>
      </main>
